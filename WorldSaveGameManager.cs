...
public class WorldSaveGameManager : MonoBehaviour
{
    ...
    public CharacterSlot currentPlayerSlotBeingUsed;
    public PlayerSaveData currentPlayerData;
    ...
    public string DecideCharacterFileNameBasedOnCharacterSlotBeingUsed(CharacterSlot characterSlot) //เอาไว้ดึงชื่อแต่ละSlotมา
    {
        string fileName = "";
    ...
    public void AttemptToCreateNewGame()
    {
        ...
        {
            currentPlayerSlotBeingUsed = CharacterSlot.CharacterSlot_01;
        ...
        if (!saveFileDataWriter.CheckToSeeIfFileExists())
        {
            currentPlayerSlotBeingUsed = CharacterSlot.CharacterSlot_02;
        ...
        if (!saveFileDataWriter.CheckToSeeIfFileExists())
        {
            currentPlayerSlotBeingUsed = CharacterSlot.CharacterSlot_03;
        ...
        if (!saveFileDataWriter.CheckToSeeIfFileExists())
        {
            currentPlayerSlotBeingUsed = CharacterSlot.CharacterSlot_04;
        ...
        if (!saveFileDataWriter.CheckToSeeIfFileExists())
        {
            currentPlayerSlotBeingUsed = CharacterSlot.CharacterSlot_05;
    ...
    {
        saveFileName = DecideCharacterFileNameBasedOnCharacterSlotBeingUsed(currentPlayerSlotBeingUsed);

        saveFileDataWriter = new SaveFileDataWriter();
        saveFileDataWriter.saveDataDirectoryPath = Application.persistentDataPath;
        saveFileDataWriter.saveFileName = saveFileName;
        currentPlayerData = saveFileDataWriter.LoadSaveFile();
